      ...
      >
        ...
        {loading ? (
          ...
          <div className="py-6 flex flex-col items-center text-center">
            ...
            <span className="text-[11px] font-extrabold uppercase tracking-widest text-amber-400 bg-amber-500/10 border border-amber-500/20 px-3 py-1 rounded-full mb-3">
            ...
            <div className="flex items-center justify-center gap-2 text-xs text-textSecondary">
              ...
              <span>Esports Arena Developer Security Protocol</span>
            </div>
          </div>
        )}
      </motion.div>
